  ...
  const filteredOrders = useMemo(() => {
    ...
    if (filterType !== "all") {
      filtered = filtered.filter((order) => {
        switch (filterType) {
          case "unassigned":
            return !order.currentAssignedStaffId && !order.collected;
          case "tailoring":
    ...
    return filtered;
  }, [orders, searchQuery, filterType, currentTime]);
      ...
      <motion.div
        ...
        {orders === undefined ? (
          ...
          filteredOrders.length === 0 ? (
            ...
            <motion.div
              layout
              className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3 md:gap-4 mb-6 md:mb-8'>
          ...
          <CardContent className='space-y-3'>
            ...
            {order.collected && order.collectedAt ? (
                ...
                <div className='flex items-center gap-2'>
                  ...
                  <div className='flex-1'>
                    ...
                    <p className='text-xs text-muted-foreground'>
                      {dayjs(order.collectedAt).format(
              ...
              (isAdmin||isConsultant) ? (
                ...
                <p className="text-xs text-red-500 text-center py-1 px-1 bg-red-100 rounded-lg">Only Admins & Consultants can mark orders as collected</p>
              )
            ) : order.currentAssignedStaffId ? (
            ...
            {!order.collected && (
              <div className='flex items-center gap-2 text-xs text-muted-foreground'>
                ...
                <span>
                  Due:{" "}
                  {dayjs(order.expectedCollectionDate).format("MMM D, YYYY")}
                </span>
              </div>
            )}
          </CardContent>
